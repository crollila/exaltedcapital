import{t as a,W as c,u as i,v as d,w as e,x as I,y as m,H as h,z as u,B as v,G as O,J as S,K as g,L as s,N as k,O as T,Q as A,V as t,X as y,Y as L,Z as w,_ as f,$ as P,a0 as b,a1 as C,a2 as G,a3 as o,a4 as R,a5 as E,a6 as W,a7 as M,a8 as N,A as K}from"./theme-D9C9QvAO.js";const x=`{\r
  "type": "TypeAPL",\r
  "prepullActions": [],\r
  "priorityList": [\r
...
`,n={axe:1,dagger:2,fist:3,mace:4,offhand:5,polearm:6,shield:7,staff:8,sword:9},l={bow:1,crossbow:2,gun:3,idol:4,libram:5,thrown:6,totem:7,wand:8},an=[{key:"warrior",label:"Warrior",className:"Warrior",cls:a.ClassWarrior,role:"melee",rotations:[{label:"Leveling (any level)",json:nn},{label:"Level 60 Fury/Arms",json:rn}],spec:r=>({oneofKind:"warrior",warrior:c.create({options:i.create({startingRage:0,queueDelay:250,shout:d.WarriorShoutBattle,stance:r>=30?e.WarriorStanceBerserker:e.WarriorStanceBattle})})}),armor:r=>r>=40?4:3,weapons:[n.axe,n.dagger,n.fist,n.mace,n.polearm,n.staff,n.sword],twoHand:!0,dualWield:r=>r>=20,ranged:[l.bow,l.crossbow,l.gun,l.thrown],shield:!0},{key:"rogue",label:"Rogue",className:"Rogue",cls:a.ClassRogue,role:"melee",rotations:[{label:"Sinister Strike",json:Q},{label:"Backstab (dagger)",json:z},{label:"Level 60 Sinister Strike",json:Y},{label:"Level 60 Backstab",json:X}],spec:()=>({oneofKind:"rogue",rogue:I.create({options:m.create({})})}),armor:()=>2,weapons:[n.axe,n.dagger,n.fist,n.mace,n.sword],twoHand:!1,dualWield:()=>!0,ranged:[l.bow,l.crossbow,l.gun,l.thrown],shield:!1},{key:"hunter",label:"Hunter",className:"Hunter",cls:a.ClassHunter,role:"ranged",rotations:[{label:"Leveling (any level)",json:V},{label:"Level 60",json:B}],spec:()=>({oneofKind:"hunter",hunter:h.create({options:u.create({petType:v.Cat,petUptime:1,petAttackSpeed:O.OneTwo})})}),armor:r=>r>=40?3:2,weapons:[n.axe,n.dagger,n.fist,n.polearm,n.staff,n.sword],twoHand:!0,dualWield:r=>r>=20,ranged:[l.bow,l.crossbow,l.gun],shield:!1},{key:"mage",label:"Mage",className:"Mage",cls:a.ClassMage,role:"caster",rotations:[{label:"Fireball",json:U},{label:"Frostbolt",json:F},{label:"Level 60 Fire",json:q}],spec:r=>({oneofKind:"mage",mage:S.create({options:g.create({armor:r>=34?s.MageArmor:s.NoArmor})})}),armor:()=>1,weapons:[n.dagger,n.staff,n.sword,n.offhand],twoHand:!0,dualWield:()=>!1,ranged:[l.wand],shield:!1},{key:"warlock",label:"Warlock",className:"Warlock",cls:a.ClassWarlock,role:"caster",rotations:[{label:"Default",json:$}],spec:r=>({oneofKind:"warlock",warlock:k.create({options:T.create({armor:A.DemonArmor,summon:r>=20?t.Succubus:t.Imp})})}),armor:()=>1,weapons:[n.dagger,n.staff,n.sword,n.offhand],twoHand:!0,dualWield:()=>!1,ranged:[l.wand],shield:!1},{key:"shadow_priest",label:"Shadow Priest",className:"Priest",cls:a.ClassPriest,role:"caster",rotations:[{label:"Default",json:Z}],spec:()=>({oneofKind:"shadowPriest",shadowPriest:y.create({options:L.create({})})}),armor:()=>1,weapons:[n.dagger,n.mace,n.staff,n.offhand],twoHand:!0,dualWield:()=>!1,ranged:[l.wand],shield:!1},{key:"balance_druid",label:"Balance Druid",className:"Druid",cls:a.ClassDruid,role:"caster",rotations:[{label:"Default",json:x}],spec:()=>({oneofKind:"balanceDruid",balanceDruid:w.create({options:f.create({})})}),armor:()=>2,weapons:[n.dagger,n.fist,n.mace,n.staff,n.offhand],twoHand:!0,dualWield:()=>!1,ranged:[l.idol],shield:!1},{key:"feral_druid",label:"Feral Druid",className:"Druid",cls:a.ClassDruid,role:"melee",rotations:[{label:"Leveling (any level)",json:j},{label:"Level 60",json:H}],spec:()=>({oneofKind:"feralDruid",feralDruid:P.create({options:b.create({latencyMs:100})})}),armor:()=>2,weapons:[n.dagger,n.fist,n.mace,n.staff,n.offhand],twoHand:!0,dualWield:()=>!1,ranged:[l.idol],shield:!1},{key:"retribution_paladin",label:"Retribution Paladin",className:"Paladin",cls:a.ClassPaladin,role:"melee",rotations:[{label:"Default",json:J}],spec:r=>({oneofKind:"retributionPaladin",retributionPaladin:C.create({options:G.create({aura:r>=16?o.RetributionAura:o.NoPaladinAura,primarySeal:R.Righteousness})})}),armor:r=>r>=40?4:3,weapons:[n.axe,n.mace,n.polearm,n.sword],twoHand:!0,dualWield:()=>!1,ranged:[l.libram],shield:!0},{key:"elemental_shaman",label:"Elemental Shaman",className:"Shaman",cls:a.ClassShaman,role:"caster",rotations:[{label:"Default",json:D}],spec:()=>({oneofKind:"elementalShaman",elementalShaman:E.create({options:W.create({})})}),armor:r=>r>=40?3:2,weapons:[n.axe,n.dagger,n.fist,n.mace,n.staff,n.offhand],twoHand:!0,dualWield:()=>!1,ranged:[l.totem],shield:!0},{key:"enhancement_shaman",label:"Enhancement Shaman",className:"Shaman",cls:a.ClassShaman,role:"melee",rotations:[{label:"Default",json:_}],spec:()=>({oneofKind:"enhancementShaman",enhancementShaman:M.create({options:N.create({})})}),armor:r=>r>=40?3:2,weapons:[n.axe,n.dagger,n.fist,n.mace,n.staff],twoHand:!0,dualWield:()=>!1,ranged:[l.totem],shield:!0}];function en(r,p){return K.fromJsonString((r.rotations[p]||r.rotations[0]).json,{ignoreUnknownFields:!0})}export{an as S,en as r};
